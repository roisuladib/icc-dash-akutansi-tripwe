   ...
   <div id="tripwe-table">
      <div class="compt-table">
         <div class="container-fluid">
            <h1 class="title">Daftar Pelanggan</h1>
            <div class="row mt-4">
               <div class="col-12">
                  <div class="form-inline form-tabel">
                     ...
                     <div class="input-group">
                        ...
                        <button @click="getAll" class="btn"><ion-icon name="search-outline"></ion-icon></button>
                     </div>
                  </div>
               </div>
            </div>
...
export default {
  ...
  methods: {
     async getAll() {
        ...
        await axios
         .post('https://api.saebo.id/trip/pelanggan/daftarcustomer', qs.stringify({
            idlog    : key.idlog,
            user     : key.userkey,
            token    : key.token,
            search   : this.search
  ...
  created() {
     this.getAll();
     document.title = 'Tripwe jurnal | Pelanggan';
  },
  computed: {
   //   bankFilters() {
   //      return this.customers.bankFilters((data) => {
   //         return data.search.toLowerCase().match(this.search.toLowerCase());
   //      })
   //   }
  }
}
