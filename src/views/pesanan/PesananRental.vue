   ...
   <div id="tripwe-table">
      <div class="compt-table">
         <div class="container-fluid">
            <h1 class="title">Daftar Pesanan Rental</h1>
            <div class="row mt-4">
         ...
         <div class="table-responsive">
            <table class="table table-hover table-bordered">
               ...
               <tbody v-if="pesananRental.length > 0">
...
export default {
        ...
        await axios
            ...
            .then(res => {
              if (res.data.status === 102) {
                  this.pesananRental = res.data.data;
  ...
  computed: {
      filters() {
        return this.pesananRental.filter((data) => {
