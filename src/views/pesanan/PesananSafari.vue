   ...
   <div id="tripwe-table">
      <div class="compt-table">
         <div class="container-fluid">
            <h1 class="title">Daftar Pesanan Safari</h1>
            <div class="row mt-4">
         ...
         <div class="table-responsive">
            <table class="table table-hover table-bordered">
               ...
               <tbody v-if="pesananSafari.length > 0">
...
export default {
        ...
        await axios
            ...
            .then(res => {
              if (res.data.status === 102) {
                  this.pesananSafari = res.data.data;
  ...
  computed: {
      filters() {
        return this.pesananSafari.filter((data) => {
