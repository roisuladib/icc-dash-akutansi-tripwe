   ...
   <div id="tripwe-table">
      <div class="compt-table">
         <div class="container-fluid">
            <h1 class="title">Daftar Penjualan Rental</h1>
            <div class="row mt-4">
         ...
         <div class="table-responsive">
            <table class="table table-hover table-bordered">
               ...
               <tbody v-if="penjualanRental.length > 0">
...
export default {
  ...
  methods: {
    async getAll() {
        document.title = 'Tripwe jurnal | Penjualan Rental';
        ...
        axios
          ...
          .then(res => {
              if (res.data.status === 102) {
                this.penjualanRental = res.data.data;
  ...
  computed: {
    filters() {
        return this.penjualanRental.filter((data) => {
